...
# Load parameters from the parameter dictionary
identification = param_dict["identification"]
sentiment_model_path = param_dict['sentiment_model_path']
sentiment_bound_path = param_dict["sentiment_bound_path"] + str(identification) + '_sentiment_inference_threshold.pkl'
loner_bound_path = param_dict['loner_bound_path'] + str(identification) + '_clustering_inference_threshold.pkl'
topic_not_take_li = param_dict["topic_donot_predict"]
model1_device = param_dict["model1_device"]
model1_path = param_dict['model1_path']
...
# Other functions and variables remain the same
...
url = "https://nlp-sentiment-zvv6lrzk5q-uc.a.run.app/api/v1/nlp/sentiment"
...
# Load topic data
comment_topic_di, topic_cluster_di, topic_statistic_df, topic_di = pickle.load(open('/path/to/your/data', 'rb'))
topic_di = {}
...
def cluster_text_inference_inhouse(input_comment):
    """
    Perform sentiment analysis, topic prediction, and clustering on input comments.
    
    Args:
        input_comment (list): List of input comments.
        
    Returns:
        json_object (str): JSON object containing the results of the analysis.
    """
    ...
    comment_df = comment_df[comment_df['sent_len'] > 0]

    # Topic prediction and clustering
    # ... (omitted for brevity)
...
def semtiment_analytic_inhouse1(body):
    ...
    Returns:
    tuple: Contains sentiment analysis results.
    """
...
def cut_into_sentences(ori_text, trans_text, language_id):
    """
    Cut the input text into sentences using different tokenizers and return the best sentences.
    """
    only_en = False
...
encoding_path = '/path/to/your/encoding/file'
...
def cluster_text_inference_inhouse(input_comment):
    ...
    model1 = AutoModel.from_pretrained('/path/to/your/xlmr_based_model')
    model2 = AutoModel.from_pretrained('/path/to/your/txlmr_model')
    model3 = AutoModel.from_pretrained('/path/to/your/infoxlm_model')
    model4 = AutoModel.from_pretrained('/path/to/your/xlmalign_model')

    tokenizer1 = AutoTokenizer.from_pretrained('/path/to/your/xlmr_based_tokenizer')
    tokenizer2 = AutoTokenizer.from_pretrained('/path/to/your/txlmr_tokenizer')
    tokenizer3 = AutoTokenizer.from_pretrained('/path/to/your/infoxlm_tokenizer')
    tokenizer4 = AutoTokenizer.from_pretrained('/path/to/your/xlmalign_tokenizer')
...
model1.save_pretrained('/path/to/your/xlmr_based_model')
model2.save_pretrained('/path/to/your/txlmr_model')
model3.save_pretrained('/path/to/your/infoxlm_model')
model4.save_pretrained('/path/to/your/xlmalign_model')

tokenizer1.save_pretrained('/path/to/your/xlmr_based_tokenizer')
tokenizer2.save_pretrained('/path/to/your/txlmr_tokenizer')
tokenizer3.save_pretrained('/path/to/your/infoxlm_tokenizer')
tokenizer4.save_pretrained('/path/to/your/xlmalign_tokenizer')

# Load models and tokenizers
AutoModel.from_pretrained('/path/to/your/xlmalign_model')

# Load and save topic_cluster_di and topic_statistic_df
_, topic_cluster_di, topic_statistic_df, _ = pickle.load(open('/path/to/your/base_cluster_path', 'rb'))
pickle.dump(obj=(topic_cluster_di, topic_statistic_df), file=open('/path/to/your/base_cluster_path', 'wb'))
